...
@Component({
	selector: 'kt-presenceboard',
	templateUrl: './presenceboard.component.html',
	styleUrls: ['presenceboard.component.scss'],
})
export class PresenceboardComponent implements OnInit {
